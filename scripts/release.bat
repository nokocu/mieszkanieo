...
set "TAURI_EXE=%~dp0..\src-tauri\target\release\mieszkanieo.exe"
set "WEBVIEW_DLL=%~dp0..\src-tauri\target\release\WebView2Loader.dll"
...
if not exist "%TAURI_EXE%" (
    echo Error: Tauri executable not found at: %TAURI_EXE%
...
echo.
echo Release folder prepared successfully at: %OUTPUT_DIR%
pause
